...
class MapFileQueueTest  {
    ...
    @Before
    void init(){
        consumeMapFile = new ConsumeMapFile( "E:\\index\\config", 1024);
        commitMapFile = new CommitMapFile("E:\\index\\commit", 1024, consumeMapFile );
    }
    ...
    void testAppendMessage() {
        ...
        MapFileElemResult rsp = consumeMapFile.getIndexBuffer(14);
        ByteBuffer buffer = rsp.getByteBuffer();
    ...
    void testAppendMessageFile() {
        ...
        CommonUtils.string2File("jeffchan","E:\\index\\consume.json" )
    }
}
